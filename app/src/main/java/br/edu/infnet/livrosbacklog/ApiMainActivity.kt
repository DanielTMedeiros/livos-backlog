...
import br.edu.infnet.livrosbacklog.databinding.ActivityApiMainBinding
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            withContext(Dispatchers.Main) {
                if (response.isSuccessful) {
                    ...
                    val intent = Intent(this@ApiMainActivity, DetailsActivity::class.java)
                    intent.putExtra("json_results", prettyJson)
                    this@ApiMainActivity.startActivity(intent)
